...
public class ImageMerge {
    ...
    public static void overlyingImageTest() {
        ...
        String sourceFilePath = "F:\\bb\\1.jpg";
        String waterFilePath = "F:\\bb\\2.png";
        String saveFilePath = "F:\\bb\\cc.png";
        try {
    ...
    public static void imageMargeTest() {
        ...
        String saveFilePath = "/Users/zhgr/vtuweb/5G.jpg";
        String divingPath = "/Users/zhgr/vtuweb/videoLog/logo.png";
        String margeImagePath = "/Users/zhgr/vtuweb/test3.jpg";
        try {
            bi1 = getBufferedImage(saveFilePath);

            bi2 = getBufferedImage(divingPath);

            double scale = (double)500/bi1.getWidth();
            bi1 = ImageUtils.modifyImageScale(bi1,scale);

            System.out.println("bi1的长："+bi1.getWidth());
            System.out.println("bi1的高："+bi1.getHeight());


            bi2 = ImageUtils.modifyImageScale(bi2,0.2);
            System.out.println("bi2的长："+bi2.getWidth());
            System.out.println("bi2的高："+bi2.getHeight());
